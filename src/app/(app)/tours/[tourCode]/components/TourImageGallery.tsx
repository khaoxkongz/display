    ...
    <>
      <div className="grid grid-cols-4 gap-2">
        <div className="col-span-2">
          ...
          >
            <Image
              src={visibleImages[0].src || "/placeholder.svg"}
              width={800}
              height={500}
        ...
        <div className="space-y-2">
          ...
          >
            <Image
              src={visibleImages[1].src || "/placeholder.svg"}
              width={800}
              height={240}
          ...
          >
            <Image
              src={visibleImages[2].src || "/placeholder.svg"}
              width={800}
              height={240}
        ...
        <div className="space-y-2">
          ...
          >
            <Image
              src={visibleImages[3].src || "/placeholder.svg"}
              width={800}
              height={240}
          ...
          {hasMoreImages ? (
            ...
            >
              <Image
                src={visibleImages[5].src || "/placeholder.svg"}
                width={800}
                height={240}
            ...
            >
              <Image
                src={visibleImages[4].src || "/placeholder.svg"}
                width={800}
                height={240}
                alt={visibleImages[4].alt}
                className="h-auto w-full object-cover transition-transform hover:scale-105"
              />
            </div>
          )}
