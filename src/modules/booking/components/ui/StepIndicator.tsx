...
function StepIndicator({ currentStep }: { currentStep: number }) {
  ...
  return (
    <div className="relative flex items-center justify-between">
      ...
      <div className="h-2 w-full overflow-hidden rounded-full bg-gray-200 md:hidden">
        <div
        ...
        {steps.map((step) => (
          <div
            ...
            className={cn(
              ...
              currentStep >= step.number ? "text-[#1877f2]" : "text-gray-400"
            )}
          >
            {step.title}
          </div>
      ...
      <div className="absolute top-7 right-7 left-7 hidden md:flex">
        {steps.slice(0, -1).map((_, index) => (
          <div
            ...
            className={cn(
              "h-1 flex-1",
              currentStep > index + 1 ? "bg-[#1877f2]" : "bg-gray-200"
            )}
          />
        ))}
      </div>
